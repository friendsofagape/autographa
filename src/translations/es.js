export default {
  ...
  "label-select-language":
    "Seleccione el idioma para configurar la aplicación en:",
  ...
  "placeholder-path-of-usfm-files":
    "Ruta de la carpeta que contiene archivos USFM",
  "placeholder-select-usfm-files": "Seleccione los archivos USFM",
  "placeholder-saving-usfm-files":
    "Ruta de la carpeta para guardar archivos USFM",
  ...
  "tooltip-exitrecorder": "Grabador de salida",
  "tooltip-exportrecording": "Grabación de exportación",
  "tooltip-micsettings": "Ajustes de micrófono",
  "tooltip-nextverse": "Siguiente verso",
  "tooltip-previousverse": "Verso anterior",
  "tooltip-start/stop":
    "Mantenga presionado durante 1 segundo para comenzar a grabar.",
  "tooltip-deleterecording": "Eliminar grabación",
  "tooltip-change-translationhelpslanguage":
    "Cambiar la traducción ayuda al idioma",
  ...
  "tooltip-language-validation":
    "La longitud debe tener entre 2 y 8 caracteres y no puede comenzar con un número.",
  "dynamic-msg-bib-code-start-with-number":
    "La longitud del código de idioma de la Biblia debe tener entre 2 y 8 caracteres y no puede comenzar con un número.",
  ...
  "dynamic-msg-exit-recorder":
    "Estás segura de que quieres salir de la grabadora?",
  "dynamic-msg-delete-recording":
    "¿Estás seguro de que deseas eliminar la grabación de este versículo?",
  "dynamic-msg-delete-undonemsg": "(Las eliminaciones no se pueden deshacer!)",
  "dynamic-msg-successfully-deleted": "Eliminado exitosamente",
  "dynamic-msg-export-recording": "Grabación exportada exitosamente",
  "dynamic-not-compatible-with-translation-help":
    "La grabadora no es compatible con la ayuda de traducción. Cambie el diseño.",
  ...
  "dynamic-msg-selected-ref-ver":
    "Este capítulo no está disponible en la versión de referencia seleccionada.",
  "dynamic-msg-book-exported": "Libro exportado",
  "dynamic-msg-trans-data": "Datos de traducción",
  "dynamic-msg-enter-translation":
    "Ingrese los Detalles de la Traducción en la configuración para continuar con la Exportación.",
  ...
  "dynamic-compare-mode":
    "El modo de comparación no es significativo en diferentes idiomas. Asegúrate de haber configurado los detalles de la traducción en Configuración y seleccionado el mismo idioma en todos los paneles.",
  "dynamic-msg-bib-name-validation": "Se requiere el nombre de la Biblia.",
  "dynamic-msg-bib-code-validation":
    "Se requiere el código de idioma de la Biblia.",
  "dynamic-msg-bib-version-validation": "Se requiere la versión de la Biblia.",
  "dynamic-msg-bib-path-validation":
    "La ubicación de la carpeta es obligatoria.",
  "dynamic-msg-saved-trans":
    "Se han guardado los detalles de la traducción correctamente.",
  ...
  "dynamic-msg-parse-error":
    "Se ha producido un error al analizar el archivo USFM.",
  "dynamic-msg-del-ref-text":
    "¿Está seguro de que desea eliminar este texto de referencia?",
  "dynamic-msg-del-unable": "No se puede eliminar, inténtalo de nuevo.",
  "dynamic-msg-ren-unable":
    "No se puede cambiar el nombre. Vuelva a intentarlo.",
  "dynamic-msg-name-taken":
    "Ese nombre ya está tomado. Por favor intente un nombre diferente.",
  ...
  "dynamic-msg-save-language":
    "Cambios guardados correctamente. Reinicie la aplicación para que los cambios surtan efecto.",
  "dynamic-msg-offline":
    "Parece que no tiene una conexión a Internet que funcione para ver esto. <br /> Inténtelo de nuevo cuando esté en línea.",
  ...
  "label-auto-update-info":
    "Si está activado esto permitiría que la aplicación se conecte automáticamente a Internet (cuando esté disponible), descargue y luego instale actualizaciones que son publicadas por el equipo de Autographa.",
  "label-auto-update": "Actualización automática",
  "label-radio-enable": "Habilitar",
  "label-radio-disable": "Inhabilitar",
  "label-please-wait":
    "Esto puede tomar unos pocos minutos. <br/> por favor espera",
  "label-warning": "Advertencia",
  "label-username": "Nombre de usuario",
  "label-pwd": "Contraseña",
  "label-credentials": "Cartas credenciales",
  "label-no-project": "No hay proyectos para mostrar.",
  "label-paratext": "Paratext",
  "label-wacs": "WACS",
  "label-door43": "Door43",
  "label-other": "Otro",
  "label-endpoint": "Punto final",
  "label-sign-in": "Registrarse",
  "label-override-text":
    "Esto sobrescribirá cualquier texto existente en los libros seleccionados",
  "label-selection": "Por favor, haz una selección para continuar",
  "label-uploading-warning":
    "El texto cargado sobrescribirá cualquier cambio no sincronizado en su proyecto en la nube",
  ...
  "usfm-chaper-missing":
    "Los archivos USFM sin ID de capítulos no son compatibles",
  ...
  "username-req": "Se requiere nombre de usuario",
  "password-req": "se requiere contraseña",
  "text-info-paratext":
    "Obtenga más información sobre Paratext y regístrese en $.",
  "text-info-door43": "Obtenga más información sobre Door43 y regístrese en $.",
  "text-info-wacs": "Obtenga más información sobre WACS y regístrese en $.",
