export default {
  ...
  "label-override-text":
    "This will overwrite any existing text in the selected books.",
  "label-selection": "Please make a selection to continue.",
  "label-uploading-warning":
    "The uploaded text will overwrite any un-synced changes in your project on the cloud",
  "label-imported-book": "Import Successful",
  "label-exported-book": "Upload Successful",
  "label-create-project": "Create New Project",
  ...
  "tooltip-exitrecorder": "Exit recorder",
  "tooltip-exportrecording": "Export recording",
  "tooltip-micsettings": "Mic settings",
  ...
  "label-total-chapter-length": "Total chapter length:",
  "export-html": "HTML",
  "export-usfm": "USFM",
  "export-html-1-column": "1-Column HTML",
  "export-html-2-column": "2-Column HTML",
  "tooltip-language-validation":
    "Length should be between 2 and 8 characters and can’t start with a number.",
  ...
  "dynamic-msg-exit-recorder": "Are you sure you want to exit the recorder?",
  "dynamic-msg-delete-recording":
    "Are you sure you want to Delete the Recording of this verse?",
  "dynamic-msg-delete-undonemsg": "(Deletions cannot be undone!)",
  "dynamic-msg-successfully-deleted": "Successfully deleted",
  "dynamic-msg-export-recording": "Exported recording successfully",
  ...
  "dynamic-msg-selected-ref-ver":
    "This chapter is not available in the selected reference version.",
  ...
  "dynamic-msg-del-ref-text":
    "Are you sure you want to delete this reference text?",
  ...
  "dynamic-msg-sync-book-list": "Successfully synchronized books:\n$",
  "dynamic-msg-sync-book-count": "Successfully synchronized $ books.",
  "dynamic-not-compatible-with-translation-help":
    "Recorder not compatible with translation help, Please change the layout",
  ...
  "dynamic-msg-save-language":
    "Successfully saved changes. Restart the application for the changes to take effect.",
  "dynamic-msg-offline":
    "You do not seem to have a working internet connection to view this.<br /> Please try again after you are online.",
  "label-auto-update-info":
    "If enabled this would allow the application to automatically connect to the internet (when available), download and thereafter install updates that are released by the Autographa team.",
  ...
  "text-info-paratext": "Learn more about Paratext and register at $.",
  "text-info-door43": "Learn more about Door43 and register at $.",
  "text-info-wacs": "Learn more about WACS and register at $.",
