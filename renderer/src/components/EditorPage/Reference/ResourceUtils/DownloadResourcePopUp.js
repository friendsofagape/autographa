        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-center h-screen">
              <div className="w-2/5 max-h-[32rem] items-center justify-center m-auto z-50 shadow rounded overflow-y-scroll bg-white">

                <div aria-label="resources-download-title" className="flex w-2/5 justify-center fixed rounded-t shadow uppercase bg-secondary text-white p-2 text-xs tracking-widest leading-snug">
                  {selectResource}
                  {' '}
                  Resource Collection
                </div>
                <div aria-label="resources-download-filter" className="flex w-2/5 mt-8 justify-between fixed bg-white text-black p-2  ">
                  <span className="text-sm font-medium">Select Resources to Download</span>
                  <span className="cursor-pointer" title="filter">
                ...
                <div aria-label="resources-download-content" className="flex-col mt-[4.5rem] p-2">
