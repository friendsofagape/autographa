...
const getValue = async (filteredData, twURL, repoName) => {
...
export default async function ObsTsvToChapterLevelMd(tsvJSON, chapter, twURL, repoName) {
  ...
  const notesObj = await getValue(filteredData, twURL, repoName);
  return notesObj;
}
